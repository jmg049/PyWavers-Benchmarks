...
def benchmark_f32_as_i16_8000(runner):
...
def benchmark_f32_as_i16_22050(runner):
    ...
    runner.timeit("PyWavers-f32_as_i16",
                  stmt='for f in DATA: pywavers.read(f, dtype=np.int16)',
                  setup=f"import pywavers; import numpy as np; DATA = {DATA}")
    runner.timeit("Soundfile-f32_as_i16",
                  stmt='for f in DATA: soundfile.read(f, dtype=np.int16)',
                  setup=f"import soundfile;import numpy as np; DATA = {DATA}")


def benchmark_f32_as_i16_44100(runner):
...
if __name__ == '__main__':
    ...
    benchmark_f32_as_i16_8000(runner)
    benchmark_f32_as_i16_16000(runner)
    benchmark_f32_as_i16_22050(runner)
    benchmark_f32_as_i16_44100(runner)