...
$(which python) benches/writing/bench_write_i16_as_f32.py -o ./bench_results/writing/bench_write_i16_as_f32_timings.json

printf "________________________________________\n"
printf "Benchmarking using track_memory\n"
$(which python) benches/writing/bench_write_i16_as_f32.py --track-memory -o ./bench_results/writing/bench_write_i16_as_f32_track_memory.json

printf "________________________________________\n"
printf "Benchmarking using tracemalloc\n"
$(which python) benches/writing/bench_write_i16_as_f32.py --tracemalloc -o ./bench_results/writing/bench_write_i16_as_f32_tracemalloc.json
