...
printf "Starting benchmark _ GenSpeech I16\n"
printf "________________________________________\n"
printf "Benchmarking PyWavers on GenSpeech dataset...\n"
$(which python) benches/writing/bench_write_i16.py -o ./bench_results/writing/bench_write_i16_timings.json


printf "________________________________________\n"
printf "Benchmarking using track_memory\n"
$(which python) benches/writing/bench_write_i16.py --track-memory -o ./bench_results/writing/bench_write_i16_track_memory.json


printf "________________________________________\n"
printf "Benchmarking using tracemalloc\n"
$(which python) benches/writing/bench_write_i16.py --tracemalloc -o ./bench_results/writing/bench_write_i16_tracemalloc.json
