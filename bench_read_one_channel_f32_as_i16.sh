...
$(which python) benches/reading/bench_read_f32_as_i16.py -o ./bench_results/reading/bench_read_f32_as_i16_timings.json

printf "________________________________________\n"
printf "Benchmarking using track_memory\n"
$(which python) benches/reading/bench_read_f32_as_i16.py --track-memory -o ./bench_results/reading/bench_read_f32_as_i16_track_memory.json

printf "________________________________________\n"
printf "Benchmarking using tracemalloc\n"
$(which python) benches/reading/bench_read_f32_as_i16.py --tracemalloc -o ./bench_results/reading/bench_read_f32_as_i16_tracemalloc.json
